      ...
      <div key={item.message_id} className="timeline-row">
        <div className="timeline-step">
          <div className="timeline-step-head">
            <span className="timeline-step-icon"><Wrench size={14} /></span>
            <span className="timeline-step-title">调用工具 {item.tool_name}</span>
          </div>
      ...
      <div className="chat-messages">
        ...
        {sending && !hasStreamingAssistantMessage ? (
          <div className="message-wrapper receive">
            ...
            <div className="message-content">
              <div className="message-name">Leader Agent</div>
