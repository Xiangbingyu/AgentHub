...
from app.schemas.agent_run_input import AgentRunInputResponse, InputEventType
from app.schemas.delegate_tool import DelegateToolRequest
...
def test_delegate_tool_creates_worker_run_and_emits_parent_callback() -> None:
    ...
    subtask = STORE.subtasks[response.subtask_id]
    worker_run = STORE.agent_runs[response.worker_run_id]
    parent_after_delegate = STORE.agent_runs[parent_run.run_id]
