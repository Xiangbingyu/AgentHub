...
class RuntimeAssembler:
    ...
    def _resolve_executor_policy(self, runtime_snapshot: dict[str, Any]) -> dict[str, Any]:
        ...
        if executor_policy.get("kind") == "framework_cli" and not executor_policy.get("framework_allowed_tools"):
            executor_policy["framework_allowed_tools"] = ["Read", "Edit", "Bash", "Write"]
