...
def build_worker_mode_prompt() -> str:
    return (
        ...
        "when a task explicitly requires shell-based file relocation, copy, or rename operations, use bash_tool as the first action; "
        "do not use code_tool as a substitute for shell-based move, copy, or rename work"
    )
